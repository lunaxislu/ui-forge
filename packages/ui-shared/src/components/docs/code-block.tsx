...
export async function CodeBlock({ code, lang = "tsx", filename, category, sectionName, pagePath }: CodeBlockProps) {
    ...
    return (
        <div className="flex h-full flex-col">
            <div className="flex items-center justify-between border-b bg-muted px-4 py-3">
                <span className="font-mono text-xs font-medium text-foreground/80">{filename}</span>
                <CopyButton
                    code={normalizedCode}
                    category={category}
